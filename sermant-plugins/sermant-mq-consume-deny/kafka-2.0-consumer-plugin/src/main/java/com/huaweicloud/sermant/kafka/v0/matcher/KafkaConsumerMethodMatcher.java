...
package com.huaweicloud.sermant.kafka.v0.matcher;
...
public abstract class KafkaConsumerMethodMatcher extends MethodMatcher {
    private static final List<String> INCLUDE_METHOD = Arrays.asList("assignment", "subscription", "subscribe",
        "assign", "unsubscribe", "poll", "commitSync", "commitAsync", "seek", "seekToBeginning", "seekToEnd",
        "position", "committed", "metrics", "partitionsFor", "listTopics", "paused", "pause", "resume",
        "offsetsForTimes", "beginningOffsets", "endOffsets", "wakeup");
